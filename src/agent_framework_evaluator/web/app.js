...
const { createAgentPromptView } = window.AgentPromptView;
...
function handleSessionResult(msg) {
  ...
  if (msg.prompt_snapshots && typeof msg.prompt_snapshots === "object") {
    agentPromptView.setPromptSnapshots(
...
const agentPromptView = createAgentPromptView({
  agentInput,
  agentPromptDisplay,
  agentPromptEmpty,
  agentPromptExpanded,
  ...
  agentUserSection,
  getEnvPath: () => sessionClient.getEnvPath(),
  getSessionId: () => sessionClient.getSessionId(),
});
